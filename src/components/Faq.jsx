...
export default function Faq() {
  return (
    <section className=" flex justify-between  relative h-screen  container mx-auto  bg-[#E8EEE7]  mt-36 rounded-[36px] pt-[80px] pl-[94.5px] pr-[74px] ">
      <div>
        <span className="font-style font-[400] text-[32px] text-[#9E9D9D] mb-[20px] ">
          What's your mind
        </span>
        <h1 className="font-[600] text-[60px] text-primarybg  ">
          Ask Questions
        </h1>
        <svg
          width="491"
      ...
      <div className="flex flex-1 flex-col mt-20 ml-[221px]">
        <Accordion />
      </div>
    </section>
  );
